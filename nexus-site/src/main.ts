...
function init(): void {
  ...
  // Communications terminal (Contact page) — renders the signal field and
  // entrance choreography. Unconditional like initNetwork: rendering is not
  // animation; no #ct-root on other pages = no-op.
  initContact();
